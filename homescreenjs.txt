...
const styles = StyleSheet.create({
  container: {
    flexGrow: 1,
    padding: 15,
    backgroundColor: '#ffffff', // Soft background color
  },
  profileHeader: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  profileImage: {
    ...
    marginRight: 15,
    borderWidth: 3,
    borderColor: '#d1d1d1', // Soft border around the image
  },
  profileName: {
    fontSize: 26,
    fontWeight: '700',
  ...
  chartContainer: {
    ...
    marginVertical: 20,   // Add some margin to separate from the other content
  },
  mealPlansHeader: {
    fontSize: 24,
    fontWeight: '700',
